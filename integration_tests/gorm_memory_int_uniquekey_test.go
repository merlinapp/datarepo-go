...
func TestGormMemoryIntegrationUniqueKeyTestSuite(t *testing.T) {
	...
	suite.Run(t, new(GormMemoryIntegrationUniqueKeyTestSuite))
}

func (s *GormMemoryIntegrationUniqueKeyTestSuite) TestGetNonExistentBookType() {
	ctx := s.system.Ctx
...
func (s *GormMemoryIntegrationUniqueKeyTestSuite) TestGetExistentBookType() {
	ctx := s.system.Ctx
...
func (s *GormMemoryIntegrationUniqueKeyTestSuite) TestGetExistentAndNonExistentBookTypes() {
	ctx := s.system.Ctx
	typeName := "Digital Book"
